    ...
    >
      <div className="flex items-center justify-between w-full px-6  xl:px-[23%]  font-bold py-[1rem]">
        ...
        <ul className="hidden md:flex lg:flex gap-[2.7rem] text-[15px]">
          ...
          <li >
            <button onClick={toggleLang} className={scrolled ? "text-black cursor-pointer" : "text-white" }>
        ...
        >
          {open ? <FontAwesomeIcon icon={faX} size="sm" /> : <FontAwesomeIcon icon={faBarsStaggered} size="sm" />}
        </button>
      </div>
