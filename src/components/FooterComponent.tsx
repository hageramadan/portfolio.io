    ...
    >
      <div className="px-6 custom-blog-margin xl:px-[23%] py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 text-start">
          ...
          {/* Explore */}
          <div>
            <h5 className="uppercase font-bold mb-4 text-pro">{dict.explore}</h5>
            <ul className="space-y-3">
              <li>
                <Link href="/about" className="flex items-center gap-2 hover:text-pro transition">
                  <FontAwesomeIcon icon={faAngleRight} className="text-pro text-xs" />
                  {dict.about}
                </Link>
              </li>
              <li>
                <Link href="/contact" className="flex items-center gap-2 hover:text-pro transition">
                  <FontAwesomeIcon icon={faAngleRight} className="text-pro text-xs" />
                  {dict.contact}
                </Link>
              </li>
              <li>
                <Link href="/portfolio" className="flex items-center gap-2 hover:text-pro transition">
                  <FontAwesomeIcon icon={faAngleRight} className="text-pro text-xs" />
                  {dict.portfolio}
                </Link>
              </li>
              <li>
                <Link href="/blog" className="flex items-center gap-2 hover:text-pro transition">
                  <FontAwesomeIcon icon={faAngleRight} className="text-pro text-xs" />
                  {dict.blog}
                </Link>
              </li>
          ...
          {/* Company */}
          <div>
            <h5 className="uppercase font-bold mb-4 text-pro">{dict.company}</h5>
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h5 className="uppercase font-bold mb-4 text-pro">{dict.haveQuestions}</h5>
